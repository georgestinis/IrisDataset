...
while (ans == 'y'):
       ...
       while (True):
              ...
              if (choice_2 == 1):
                     ...
                     plt.subplot(311)
                     plt.plot(X_train[:,0], X_train[:,2], 'b.')
                     plt.title("X-train με train_test_split - Adaline")
                     plt.subplot(312)
                     plt.plot(X_val[:,0], X_val[:,2], 'r.')
                     plt.title("X-val με train_test_split - Adaline")
                     plt.subplot(313)
                     plt.plot(X_test[:,0], X_test[:,2], 'r.')
                     plt.title("X-test με train_test_split - Adaline")
                     plt.tight_layout()
                     plt.show()
                     ...
                     plt.show()
                     # Λύση ελαχίστων τετραγώνων με train_test_split σε X_train, X_test, X_val
                     # Αλλαγή πινάκων στόχου απο 0 σε -1 και θέτω ως τύπο δεδομένων το float64 για να λειτουργήσει το pinv
                     X_train, X_test, y_train, y_test = ms.train_test_split(x, t, test_size=0.1)
                     y_test[y_test == 0] = -1
                     X_train, X_val, y_train, y_val = ms.train_test_split(X_train, y_train, test_size=0.1)
                     ...
                     plt.subplot(311)
                     plt.plot(X_train[:,0], X_train[:,2], 'b.')
                     plt.title("X-train με train_test_split - Λύση Ελαχίστων Τετραγώνων")
                     plt.subplot(312)
                     plt.plot(X_val[:,0], X_val[:,2], 'r.')
                     plt.title("X-val με train_test_split - Λύση Ελαχίστων Τετραγώνων")
                     plt.subplot(313)
                     plt.plot(X_test[:,0], X_test[:,2], 'r.')
                     plt.title("X-test με train_test_split - Λύση Ελαχίστων Τετραγώνων")
                     plt.tight_layout()
                     plt.show()
                     ...
                     plt.title("X-train - Λύση Ελαχίστων Τετραγώνων")
                     plt.show()
                     ...
                     plt.title("X-test - Λύση Ελαχίστων Τετραγώνων")
                     plt.show()
              elif (choice_2 == 4):
                     break
